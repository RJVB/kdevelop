...
void StandardDocumentationView::setOverrideCss(const QUrl& url)
{
    Q_UNUSED(url);
    return;
}

void StandardDocumentationView::load(const QUrl& url)
{
    Q_D(StandardDocumentationView);
...
void StandardDocumentationView::load(const QUrl& url, const QByteArray& content)
{
    Q_D(StandardDocumentationView);
...
void StandardDocumentationView::restore()
{
    Q_D(StandardDocumentationView);
...
void StandardDocumentationView::setHtml(const QString& html)
{
    Q_D(StandardDocumentationView);
...
void StandardDocumentationView::setNetworkAccessManager(QNetworkAccessManager* manager)
{
    Q_UNUSED(manager);
    return;
}

void StandardDocumentationView::setDelegateLinks(bool delegate)
{
    Q_UNUSED(delegate);
    return;
}
